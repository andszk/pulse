...
class PULSE(torch.nn.Module):
    def __init__(self, cache_dir, verbose=True):
        ...
        with open_url("https://drive.google.com/file/d/1On4faywQ6XeIWV3QyaF1IOTdhGNFI0Tz", cache_dir=cache_dir, verbose=verbose) as f:
        ...
        if Path("gaussian_fit.pt").exists():
            ...
            with open_url("https://drive.google.com/file/d/1x94Ts5wAAFvBOW56EXbmggNOKLPuS0wb", cache_dir=cache_dir, verbose=verbose) as f:
